...
const canticosData = {
    "1 - Entrada": [
        ...
        "Entrada - Por Entre Aclamações.pdf",
    ...
    "5 - Aclamação Evangelho": [
        "Aclamação - A vossa palavra senhor.jpeg",
    ...
    "7 - Santo": [
        ...
        "Santo - Santo santo santo éh o senhor.jpeg",
        "hosana_eh.pdf",
    ...
    "9 - Comunhão": [
        "Comunhão - Eis que sou o pão da vida.jpeg",
        "Comunhão - Presença Linda.pdf",
        "a_barca.pdf",
        "a_ti_meu_deus.pdf",
    ...
    "14 - Diversos": [
        "Consagração a nossa senhora.pdf",
...
function adicionarAOrdem(pasta, cantico) {
    ...
    // Feedback visual
    showNotification('Cântico adicionado à ordem da missa!');
}
...
function renderOrdemMissa() {
    if (ordemMissa.length === 0) {
        ordemLista.innerHTML = `
            <div class="drop-zone">
                <p>Arraste os cânticos aqui para montar a ordem da missa</p>
            </div>
        `;
        return;
    }
...
if ('ontouchstart' in window) {
    ...
    // Adicionar CSS específico para touch
